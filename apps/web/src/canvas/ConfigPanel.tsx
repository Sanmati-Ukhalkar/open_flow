        ...
        return (
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              >
                <option value="groq/compound">Groq Compound (Groq - Recommended)</option>
                <option value="groq/compound-mini">Groq Compound Mini (Groq)</option>
                ...
                <option value="canopylabs/orpheus-v1-english">Orpheus v1 English (Groq)</option>
                <option value="canopylabs/orpheus-arabic-saudi">Orpheus Arabic Saudi (Groq)</option>
                <option value="meta-llama/llama-prompt-guard-2-86m">Llama Prompt Guard 2 86M (Groq)</option>
                <option value="meta-llama/llama-prompt-guard-2-22m">Llama Prompt Guard 2 22M (Groq)</option>
